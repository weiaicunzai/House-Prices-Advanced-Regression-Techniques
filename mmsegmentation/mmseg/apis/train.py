...
def train_segmentor(model,
    ...
    # for key, val in cfg.checkpoint_config.items():
    #     # print(key, pretty_print(val))
    ...
    if validate:
        ...
        # print(val_loader_cfg, loader_cfg)
        # import sys; sys.exit()
    ...
    #import inspect
    #print(inspect.getfile(runner.__class__))
    # print(os.path.abspath(sys.modules[runner.__module__].__file__))
