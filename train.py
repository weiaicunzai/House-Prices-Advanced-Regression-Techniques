...
def train(net, train_dataloader, val_loader, writer, args):
    ...
    # for iter_idx in range(1000000):
        ...
        if (iter_idx + 1) % args.eval_iter == 0:
            ...
            ckpt_manager.save_best(net, ['total_F1', 'total_Dice', 'total_Haus'],
                total, iter_idx)
            ckpt_manager.save_best(net, ['testA_F1', 'testA_Dice', 'testA_Haus'],
                testA, iter_idx)
            ckpt_manager.save_best(net, ['testB_F1', 'testB_Dice', 'testB_Haus'],
                testB, iter_idx)
